...
var config_toml_file = `config.toml.${authorname}.js`;
...
var config_toml_content = "[params.footer2.social." + `${authorname}` + "]\n" + 'headline = "' + `${authorname}` + '"\n\n';
var config_toml_instagram_content = "[[params.footer2.social." + `${authorname}` + ".links]]\n" + 'label = "Instagram"\n' + 'url = "' + `${instagram_url}` +'"\n' + 'icon = "fa-instagram"\n\n';
var config_toml_facebook_content =  "[[params.footer2.social." + `${authorname}` + ".links]]\n" + 'label = "Facebook"\n' + 'url = "' + `${facebook_url}` +'"\n' + 'icon = "fa-facebook"\n\n';
...
var stream = fs.createWriteStream(`${config_toml_file}`, {flags:'w'});
stream.write(config_toml_content + config_toml_instagram_content + config_toml_facebook_content);
